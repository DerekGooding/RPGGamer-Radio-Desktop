...
public class AudioService
{
    ...
    public readonly string SamplePath = Path.Combine(Environment.CurrentDirectory, @"View\Sample\sample-3s.mp3");

    public ImageSource? UpdateGraphic()
    {
    ...
    private readonly WaveFormRendererSettings standardSettings = new StandardWaveFormRendererSettings();
